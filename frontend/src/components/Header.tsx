  ...
  return (
    <header className="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
        <div className="col-md-3 mb-2 mb-md-0" onClick={() => Router.push("/home")}>
            ...
            <img className="mb-4 mx-auto" src="2.png" alt="" width="80" height="70" />
            </a>
        </div>

        <ul className="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0 fs-1">
            {name}
        </ul>

        <div className="col-md-3 text-end">
            <svg xmlns="http://www.w3.org/2000/svg" width="55" height="55" fill="currentColor" className="bi bi-gear" viewBox="0 0 16 16">
